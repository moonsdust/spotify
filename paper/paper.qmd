...
playlist_analysis_data |> 
  ...
  kable()
```
Not seen in @tbl-dataset-preview, before_pandemic, major, and minor are numerical versions of the mode_name and period columns. The variables that were originally the raw dataset that was scraped are track_duration_ms, tempo, loudness, mode_name, and key_mode.
...
As seen in @tbl-dataset-preview, there are multiple columns however our main variables of interests are 
